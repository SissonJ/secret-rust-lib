...
mod tests {
    ...
    pub fn generate_tx_encryption_key_from_seed() {
        ...
        assert_eq!(aw!(client.utils.get_tx_encryption_key(seed, None)).unwrap(), [62, 184, 192, 184, 224, 255, 76, 58, 234, 35, 226, 187, 90, 157, 208, 153, 216, 77, 153, 180, 231, 81, 60, 154, 97, 55, 22, 118, 67, 115, 225, 117]);
    }
