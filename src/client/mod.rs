...
mod tests {
    ...
    pub fn generate_key_from_seed() {
        ...
        let client = LCDClient::new("https://api.scrt.network".to_string(), seed);
    ...
    pub fn generate_tx_encryption_key_from_seed() {
        ...
        let client = LCDClient::new("https://api.scrt.network".to_string(), Some([94, 248, 52, 125, 0, 67, 25, 156, 142, 153, 162, 53, 86, 28, 149, 1, 238, 231, 83, 108, 15, 103, 149, 6, 21, 10, 225, 28, 135, 121, 22, 213]));
